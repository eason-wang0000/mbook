...
<div data-role="page" id="page1">
  <div data-role="header"> 
    ...
    <a href="../user/reg.html" data-ajax="false" data-role="button" data-icon="info">注册</a>
    <h3 id="reg"> 用户登录 </h3>
  </div>
  <div data-role="content">
    <form name="RegForm" method="post" action="/2016/TPpro/mbook/index.php/Home/User/login" data-ajax="false">
     ...
     <!--   <div data-role="fieldcontain">
      ...
      <div > 
        ...
        <a data-inline="true"  data-role="button"  href="../user/retrieve.html" data-ajax="false""> 找回密码 </a> 
      </div>
    </form>
  </div>
</div>
